...
// const MICRODUINO_MPROXY = 'https://tfhub.dev/google';
const MICRODUINO_MPROXY = 'https://mproxy.microduino.cn/static/ai/tfhub-tfjs-mobilenet';

const MODEL_INFO: { [version: string]: { [alpha: string]: MobileNetInfo } } = {
    '1.00': {
        '0.25': {
            url: `${MICRODUINO_MPROXY}/imagenet/mobilenet_v1_025_224/classification/1`,
            inputRange: [0, 1]
        },
        '0.50': {
            url: `${MICRODUINO_MPROXY}/imagenet/mobilenet_v1_050_224/classification/1`,
            inputRange: [0, 1]
        },
        '0.75': {
            url: `${MICRODUINO_MPROXY}/imagenet/mobilenet_v1_075_224/classification/1`,
            inputRange: [0, 1]
        },
        '1.00': {
            url: `${MICRODUINO_MPROXY}/imagenet/mobilenet_v1_100_224/classification/1`,
            inputRange: [0, 1]
        }
    },
    '2.00': {
        '0.50': {
            url: `${MICRODUINO_MPROXY}/imagenet/mobilenet_v2_050_224/classification/2`,
            inputRange: [0, 1]
        },
        '0.75': {
            url: `${MICRODUINO_MPROXY}/imagenet/mobilenet_v2_075_224/classification/2`,
            inputRange: [0, 1]
        },
        '1.00': {
            url: `${MICRODUINO_MPROXY}/imagenet/mobilenet_v2_100_224/classification/2`,
            inputRange: [0, 1]
        }
    }
};
...
class MobileNetImpl implements MobileNet {
    ...
    async load() {
        if (this.modelUrl) {
            ...
            this.model = await tfconv.loadGraphModel(`${url}/model.json`);
        }
